...
public class Server {
    ...
    public Server(String name, String address, boolean requiresPermission, boolean joinDirectly, boolean fallbackServer, List<UserData> connectedUsers, boolean online) {
        this.name = name;
